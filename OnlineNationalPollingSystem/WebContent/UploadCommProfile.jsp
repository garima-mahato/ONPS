...
<div id="templatemo_content_panel">
    ...
    <div class="content_panel_3col_section margin_right_60">
        <div class="header_01" style="text-align:center"><h4>Upload Your Profile</h4></div>
...
<tr><td>Voter ID: </td><td><input type="text" name="t2"></td></tr>
<tr><td>Educational Qualification: </td><td><input type="text" name="t3"></td></tr>
<tr><td>Professional Experience: </td><td><input type="text" name="t4"></td></tr>
<tr><td>Upload your photo: </td><td><input type="file" name="t5"></td></tr>

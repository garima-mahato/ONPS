...
<%@page import="com.ibm.db2.jcc.am.ec"%><html>
...
<div id="templatemo_content_panel">
    ...
    <div class="content_panel_3col_section margin_right_60">
        <div class="header_01" style="text-align:center"><h1> View Commissioner</h1></div>
	
	<table border="1" bgcolor="gray">
<tr><th>ID</th><th>Name</th><th>Voter ID</th><th>Educational Qualification</th><th>Professional Experience</th><th>Photo</th></tr>
<%
try
{
...
while(rs.next())
	 {
		 ...
		 %>
	<tr><td><%=s1%></td><td><%=s2%></td><td><%=s3%></td><td><%=s4%></td><td><%=s5%></td><td><%=s6%></td></tr>	 
		 <%
	 }
	 ec.dbClose();
}
...
<br>
<table align="center">
<tr><td><p align="center"><a href="WelcomeCommissioner.jsp" class="more">Back</a></p></td><td></td><td></td><td></td><td></td><td><p align="center"><a href="#" class="more">Logout</a></p></td></tr>
</table>

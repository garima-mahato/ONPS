...
<form action="Update_PasswordServ" method="post">
<h2 style="text-align: center;" text-decoration="underline">Change your Password</h2>
...
<tr><td>Confirm Password</td><td><input type="text" name="t3"></td></tr>

...
<title>OnlineNationalPollingSystem</title>
  </head>
<body>
...
<div id="templatemo_content_panel">
    ...
    <div class="content_panel_3col_section margin_right_60">
        <div class="header_01" style="text-align:center"><h4>Registration for Field Officer</h4></div>
        <h5 ><ul class="services">  <form action="New_fld_off" method="post">
<table>
<tr><td>Enter  fid: </td><td><input type="text" name="t1"></td></tr>
<tr><td>Enter Voter_Id:</td><td><input type="text" name="t2"></td></tr>
<tr><td>Enter Constituency:</td><td><input type="text" name="t3"></td></tr>
<tr><td>District:</td><td><input type="text" name="t4"></td></tr>
<tr><td>State:</td><td><input type="text" name="t5"></td></tr>

...
<div id="templatemo_content_panel">
    ...
    <div class="content_panel_3col_section margin_right_60">
        <div class="header_01" style="text-align:center"><h1 class="title" align="center">Welcome <span><%try{String uid=(String)session.getAttribute("uid");
...
catch(Exception e)
{
	e.printStackTrace();
	 ...
	 %></span></h1></div>
        ...
        <li><a href=ViewCanProfile.jsp>View Profile</a></li> 

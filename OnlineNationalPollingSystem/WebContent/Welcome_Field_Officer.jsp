...
<div id="templatemo_content_panel">
    ...
    <div class="content_panel_3col_section margin_right_60">
        <div class="header_01" style="text-align:center"><h3>Welcome Field Officer</h3></div>
        <h5 ><ul class="services">
        <li ><a href=View_Profile.jsp>View Profile</a></li>
<li><a href=View_Var_App.jsp>View Verified Voter Applications</a></li> 
<li><a href=View_NewApp.jsp>View New Voter Applications</a></li> 
<li><a href=CountVotes.jsp>Count Vote</a></li> 
<li><a href=New_Field_Off.jsp>Register New Field Officer</a></li> 
<li><a href=ChangePwd.jsp>Change Password</a></li> 
<li><a href=View_Voter.jsp>View Voter</a></li>
        </ul></h5>

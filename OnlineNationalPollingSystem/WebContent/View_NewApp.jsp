...
<h2 align="center">View New Voter Applications</h2>
<div >
...
try
{
	...
	while(rs.next())
	{
		...
		String s8=rs.getString(19);
		String s9=rs.getString(20);
		String url1="voterstatusupdate.jsp?email="+s5+"&st="+"Verified";
		String url2="voterstatusupdate.jsp?email="+s5+"&st="+"Rejected";
		String url3="image.jsp?email="+s5+"&imgid="+s7;
        String url4="image1.jsp?email="+s5+"&imgid1="+s8;
		 String url5="image2.jsp?email="+s5+"&imgid2="+s9;
		%>
		<tr>
			<td><%=s1%></td>
			<td><%=s2%></td>

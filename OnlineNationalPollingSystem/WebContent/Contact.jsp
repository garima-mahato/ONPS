...
<div id="templatemo_content_panel">
    ...
    <div class="content_panel_3col_section margin_right_60">
        <div class="header_01" style="text-align:center"><h1>Contact Us</h1></div>
        <h5 ><ul class="services">
        Address: ABC Building,XYZ Area,
                 <br>New Delhi-110 117.
                 
        <br>Mob. No.: +91**********
       <br> Email: <a href="mailto:indiaonps@gmail.com">indiaonps@gmail.com</a>
        </ul></h5>

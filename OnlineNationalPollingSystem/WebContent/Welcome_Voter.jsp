...
<%@page import="pollingPack.Voter"%><html xmlns="http://www.w3.org/1999/xhtml">
<head>
...
<div id="templatemo_content_panel">
    ...
    <div class="content_panel_3col_section margin_right_60">
        <div class="header_01" style="text-align:center"><h3 class="title" align="center">Welcome <span><%try{String uid=(String)session.getAttribute("uid");
Voter c=new Voter();
c.setVoter_Id(uid);
c.dbConnection();
...
catch(Exception e)
{
	e.printStackTrace();
	 ...
	 %></span></h3>
        ...
        <li><a href=Voter_Profile.jsp>Voter_Profile</a></li>
<li><a href=ChangePwd.jsp>Change password</a></li> 
<li><a href=Change_Address.jsp>Profile_Correction </li>
        </ul></h5>

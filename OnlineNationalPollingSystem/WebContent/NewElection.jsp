...
<div id="templatemo_content_panel">
    ...
    <div class="content_panel_3col_section margin_right_60">
        <div class="header_01" style="text-align:center"><h5>New Election Entry</h5>
<form action="NewElectionServ" method="post">
<div style="font-family:arial;background-color:gray">
<h1 align="center">Election Date Entry</h1>
<table align="center">
<tr><td>Election ID<span style="color:red">*</span>: </td><td><input type="text" name="t1" title="Enter election id"></td></tr>
<tr><td>Constitute Number<span style="color:red">*</span>: </td><td><input type="text" name="t2" title="Enter constitute number"></td></tr>

<tr><td>District<span style="color:red">*</span>: </td><td><input type="text" name="t3" title="Enter district"></td></tr>
<tr><td>State<span style="color:red">*</span>: </td><td><input type="text" name="t4" title="Enter state"></td></tr>
<tr><td>Country<span style="color:red">*</span>: </td><td><input type="text" name="t5" title="Enter country"></td></tr>
<tr><td>Election Type<span style="color:red">*</span>: </td><td><input type="text" name="t6" title="Enter election type"></td></tr>
<tr><td>Election Date<span style="color:red">*</span>: </td><td><input type="text" name="t7" title="Enter election date"></td></tr>
<tr></tr>
